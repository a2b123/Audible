...
// need to specify class in-order to make delegate variable on LoginController weak 
// it is not an enum or a struct
...
class LoginController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, LoginControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        // underscore takes in the return value of the anchors
    ...
    func scrollViewWillEndDragging(_ scrollView: UIScrollView, withVelocity velocity: CGPoint, targetContentOffset: UnsafeMutablePointer<CGPoint>) {
        ...
        // check for last page and animate it
